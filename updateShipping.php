...
require_once './updateInput.php';
require_once './updateTextArea.php';
						...
						<form action="./updateQuery.php" method="post">
							<div class="row">
								<div class="col-md-12">
									...
									<?php updateInput('text', 'ship-name', $value =$name); ?>
								</div>
								<?php showNameError(); ?>
								<div class="col-md-6">
									<label for="ship-city">Contact Number</label>
									<?php updateInput('number', 'ship-number', $value = $number); ?>
								</div>
								<?php showPhoneError(); ?>
								<div class="col-md-12">
									<label for="ship-address">Shipping Address</label>
									<?php updateInput('text', 'ship-address', $value = $address); ?>
								</div>
								<?php showAddressError(); ?>
								<div class="col-md-6">
									<label for="ship-city">City</label>
									<?php updateInput('text', 'ship-city', $value = $city); ?>
								</div>
								<?php showCityError(); ?>
								<div class="col-md-6">
									<label for="ship-zip">ZIP Code</label>
									<?php updateInput('text', 'ship-zip', $value = $zip); ?>
								</div>
								<?php showZipError(); ?>
								<div class="col-md-12">
								...
								<div class="col-md-12">
									<?php updateInput("hidden", $name = "email", $value = $email); ?>
								</div>
								<div class="col-md-6">
									<br>
