					...
					<table class="table shopping-summery">
						...
						<tbody>
							<tr>
								...
								<td class="price" data-title="Price"><span>LKR 110.00 </span></td>
								...
								<td class="total-amount" data-title="Total"><span>LKR 220.88</span></td>
						...
						<div class="row">
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<div class="checkbox">
										<label class="checkbox-inline" for="2"><input name="news" id="2" type="checkbox"> Shipping (+10LKR )</label>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li>Cart Subtotal<span>LKR 330.00</span></li>
										<li>Shipping<span>Free</span></li>
										<li>You Save<span>LKR 20.00</span></li>
										<li class="last">You Pay<span>LKR 310.00</span></li>
									</ul>
									<div class="button5">
